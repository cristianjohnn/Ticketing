...
export class NotificationDetail {
    ...
    public render(vm: NotificationDetailViewModel): string {
        ...
        if (vm.content.story) {
            storyHtml = `
                <div class="detail-story body-md">
                    <span class="font-semibold">${vm.content.story.actor}</span> 
                    ${vm.content.story.action} 
                    <strong>${vm.content.story.object}</strong>${vm.content.story.context ? ' ' + vm.content.story.context : ''}.
                </div>
            `;
        }
        ...
        return `
            ...
            <div class="detail-content-scroll">
                ...
                <div class="detail-history-placeholder mt-5">
                    <!-- Reserved for future activity history -->
                </div>
            </div>
